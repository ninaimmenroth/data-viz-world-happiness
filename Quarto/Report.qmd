...
## Distribution of the Happiness Score around the globe
```{r}
#| echo: false
#| warning: false
#| label: fig-world-map
...
p <- ggplot(data = world_data) +
  geom_sf(aes(fill = happiness_score, text = paste("Country:", name, "<br>Happiness Score:", happiness_score))) +
...
## Looking into the relationship between the happiness score and predictors {#sec-rel-pred}
...
The correlation between social support and happiness score is not as strong as for GDP per capita but still very strong.
...
There is a strong positive correlation between healthy life expectancy and the happiness score.
...
For perceptions of corruption, there seems to be a slight upward trend in happiness score for higher perceptions of corruption but it is only a fraction of data points that score high on perceptions of corruption. Also there is missing data for this variable.
