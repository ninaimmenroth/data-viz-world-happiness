...
#| fig-cap: "Matrix of scatterplots colored by cluster. HS = Happiness Score, GpC = GDP per Capita, SS = Social Support, HLE = Healthy Life Expectancy, FtmLC = Freedom to make life choices, G = Generosity, PoC = Perception of Corruption." 
...
pairs(sc_whr, col = km.out$cluster, upper.panel = NULL, gap = 0,
      text.panel = my.text.panel(c(happiness_score="HS",
                                   gdp_per_capita="GpC",
                                   social_support="SS",
                                   healthy_life_expectancy="HLE",
                                   freedom_to_make_life_choices = "FtmLC",
                                   generosity = "G",
                                   perceptions_of_corruption = "PoC")),
      cex.labels = 3,
      cex.axis = 1.2)
```
...
1.  World Happiness Report. *About*. Retrieved from <https://worldhappiness.report/about/>
2.  World Happiness Report. *World Happiness Report Appendices & Date*. Retrieved from <https://worldhappiness.report/data/>
3.  Wikipedia. (2024). *Gallup, Inc.* Retrieved from <https://en.wikipedia.org/wiki/Gallup,_Inc.#Gallup_World_Poll>
...
5.  World Happiness Report. (2024). *World Happiness Report 2024 Figure 2.1: Country Rankings by Life Evaluations in 2021-2023*. Retrieved from <https://public.tableau.com/app/profile/worldhappiness/viz/2024Draft/Figure2_1>
6.  World Happiness Report. *FAQ*. Retrieved from <https://worldhappiness.report/faq/>
7.  World Happiness Report. (2024, March 12). *Appendix 1: Statistical Appendix for Chapter 2 of World Happiness Report 2024*. Retrieved from <https://happiness-report.s3.amazonaws.com/2024/Ch2+Appendix.pdf>
8.  Islam, S. (2023) *World Happiness Report up to 2023*. Retrieved from <https://www.kaggle.com/datasets/sazidthe1/global-happiness-scores-and-factors>
...
12. Arvin, M., Lew, B. (2014). *Does income matter in the happiness-corruption relationship?*. Journal of Economic Studies. Volume 41(3). 469 - 490. <https://doi.org/10.1108/JES-02-2013-0024>
...
17.Lee, Z., Woodliffe (2010). *Misreporting: Conceptualizing Social Desirability Bias in Giving Surveys*. Voluntas 21. 569–587. <https://doi.org/10.1007/s11266-010-9153-5>
18. Lee, Z. and Sargeant, A. (2011), *Dealing with social desirability bias: an application to charitable giving*, European Journal of Marketing, Volume 45(5).703-719. <https://doi.org/10.1108/03090561111119994>
19. Fischer, R. J. (1993). *Social Desirability Bias and the Validity of Indirect Questioning*. Journal of Consumer Research, Volume 20(2). 303–315, <https://doi.org/10.1086/209351>